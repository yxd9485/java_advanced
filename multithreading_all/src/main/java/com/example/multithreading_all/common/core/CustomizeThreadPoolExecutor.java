...
public class CustomizeThreadPoolExecutor implements CustomizeThreadPoolExecutorInvoke {
     ...
     * 拒绝策略
     */
    private volatile CustomizeRejectedExecutionHandler handler;
     ...
     * 默认的拒绝策略：AbortPolicy
     */
    private static final CustomizeRejectedExecutionHandler defaultHandler = new CustomizeAbortPolicy();
    ...
    public CustomizeThreadPoolExecutor(int corePoolSize,
                                       int maximumPoolSize,
                                       long keepAliveTime,
                                       TimeUnit unit,
                                       BlockingQueue<Runnable> workQueue,
                                       ThreadFactory threadFactory,
                                       CustomizeRejectedExecutionHandler handler) {
        // 基本的参数校验
